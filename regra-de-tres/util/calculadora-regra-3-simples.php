...
<head>
	...
	<meta name="keywords" content="calculadora, calcular, regra, três, simples, matemática">
...
<div class="wrapper">
	...
	<div class="headline-center-v2 margin-bottom-20">
		<h1><i class="icon-custom icon-lg rounded-2x icon-color-u fa fa-calculator"></i>Regra de Três Simples</h1>
	</div>
	...
	<div class="panel panel-orange" style="margin-bottom:0">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="fa fa-calculator"></i> Calcular uma proporção - Regra de 3 simples</h3>
		</div>
					...
					<tr>
						...
						<td style="width:100%; padding:20px">
							<table class="table table-striped">
								<thead>
									<tr><th style="text-align:center">Grandeza 1<br><small>(exemplo: farinha)</small></th><th style="text-align:center">Grandeza 2<br><small>(exemplo: ovos)</small></th></tr>
								</thead>
								<tbody>				
									<tr><td style="text-align:center"><input type="text" class="form-control" placeholder="20" maxlength="4" size="4" name="g1"></td><td style="text-align:center"><input type="text" class="form-control" placeholder="4" maxlength="4" size="4" name="g2"></td></tr>
									<tr><td style="text-align:center"><input type="text" class="form-control" placeholder="x" maxlength="4" size="4" name="g3"></td><td style="text-align:center"><input type="text" class="form-control" placeholder="6" maxlength="4" size="4" name="g4"></td></tr>
								</tbody>		
							</table>
						</td>
					</tr>
	...
	<div class="panel panel-orange margin-bottom-40">
		...
		<div class="panel-body">                                                      
			`x=(20 xx 6)/4 hArr x=30` <br><br><b>Resposta</b>: O valor em falta na proporção é 30.			
		</div>
	</div>
	...
	<div class="headline-center-v2 margin-bottom-20">
		...
		<h2><i class="icon-custom icon-lg rounded-2x icon-color-u fa fa-info"></i>Informação</h2>
	</div>
	<div class="tag-box tag-box-v1 margin-bottom-20">
		<img style="float:right; margin:0 10px;" src="images/64_bnotas.png" width="64" height="64" alt="Bloco de notas">
		<p><span class="dropcap">O</span> conhecimento e a utilização de conceitos semelhantes à <b>regra de três simples</b> são muito antigos. Provavelmente, esta técnica teve a sua origem na antiga China, podendo ser observada em tempos muito distantes. Existem vários problemas, envolvendo cálculos muito próximos daquilo que hoje conhecemos como a regra de três simples, que podem ser lidos no famoso <i>Papiro Rhind</i>. Repara que trata-se de um documento elaborado no Egito há mais de 3000 anos! Mais recentemente, outro livro muito famoso na matemática, o <i>Liber Abaci</i> do matemático italiano Leonardo Fibonacci, também nos dá a conhecer a resolução de vários problemas envolvendo a regra de três simples.</p>
	</div>
