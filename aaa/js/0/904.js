...
*/
 ...
 for (i=0; i<3; i++) {
   if (i == 1) {
    ...
    if ((i == 1)&&((promM[0].toFixed(eval(desMista1)+2) == 0)||(promM[0].toFixed(eval(desMista1)+2) == (Math.PI).toFixed(eval(desMista1)+2))||(promM[0].toFixed(eval(desMista1)+2) == (2*Math.PI).toFixed(eval(desMista1)+2)))) {  // tan alfa = nekonecno
...
function Graf(postupovka, prom0, prom1, prom2) {     
  ...
  if ((sourX[0].toFixed(desMistaZ)>246)&&(sourX[0].toFixed(desMistaZ)<250)) {
    var rozdil = sourX[0] - 246;
    for (i=0; i<2; i++) {
      i *= 2;    
      sourX[i] -= rozdil; 
    }
  ...
  if ((sourX[0].toFixed(desMistaZ)>250)&&(sourX[0].toFixed(desMistaZ)<254)) {
    var rozdil = sourX[0] - 254;
    sourX[0] -= rozdil;
    sourY = 5;
  }
  if ((sourX[0].toFixed(desMistaZ)>70)&&(sourX[0].toFixed(desMistaZ)<74)) {
    var rozdil = 74 - sourX[0];
    for (i=0; i<2; i++) {
      i *= 2;    
      sourX[i] += rozdil; 
    }
  ...
  if ((sourX[0].toFixed(desMistaZ)>426)&&(sourX[0].toFixed(desMistaZ)<430)) {
    var rozdil = 426 - sourX[0];
    sourX[0] += rozdil;
    sourY = 345;
  }
