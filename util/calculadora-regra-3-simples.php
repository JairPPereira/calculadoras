					...
					<tr>
						...
						<td style="width:100%; padding:20px">
							<table class="table table-striped">
								...
								<tbody>				
									<tr><td style="text-align:center"><input type="text" class="form-control" placeholder="500" maxlength="4" size="4" name="g1"></td><td style="text-align:center"><input type="text" class="form-control" placeholder="8" maxlength="4" size="4" name="g2"></td></tr>
